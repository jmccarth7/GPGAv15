...
if( myid == 0  )then
    ...
    do  isource = 1, n_GP_individuals
        ...
        if( Run_GA_lmdif(i_individual) ) then
            ...
            !                  child_parameters(1:n_parameters,i_individual)
            !    write(GP_print_unit,'(A,2(1x,I6),1x,E15.7)') &
            !     'gplp:2 myid, i_individual, individual_SSE(i_individual)', &
    ...
    do
        ...
        !    write(GP_print_unit,'(A,2(1x,I6), 1x, E15.7)') &
        !    'gplp:3 send results myid, i_2_individual, individual_SSE(i_2_individual)', &
...
if( myid == 0  )then
    ...
    if( L_GP_print )then
        ...
        write(GP_print_unit,'(A)')  'gplp: individual_SSE  '
        write(GP_print_unit,'(5(1x,E15.7))')  individual_SSE(1:n_GP_individuals)
