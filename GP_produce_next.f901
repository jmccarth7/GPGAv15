...
!               write(GP_print_unit,'(//A)') 'gpn:3 after GP_Fit        '
!               write(GP_print_unit,'(A)')&
!                  'gpn:3 i_GP_gen i_GP_indiv    GP_Child_Indiv_SSE&
!                   &   GP_Child_Indiv_SSE/SSE0'
!
...
!                !flush(GP_print_unit)
            ...
            if( trim(model) /= 'fasham_fixed_tree' )then
                ...
                if( n_GP_Crossovers .gt. 0 )then
                    ...
                    !write(GP_print_unit,'(/A)') &
                    !      'gpn: aft  call GP_Tournament_Style_Sexual_Reproduction '
...
!               write(GP_print_unit,'(//A)') 'gpn:3 after GP_Tour       '
!               write(GP_print_unit,'(A)')&
!                  'gpn:3 i_GP_gen i_GP_indiv    GP_Child_Indiv_SSE&
!                   &   GP_Child_Indiv_SSE/SSE0'
!
            ...
            if( trim(model) /= 'fasham_fixed_tree' )then
                ...
                if( n_GP_Mutations .gt. 0 )then
                    ...
                    write(GP_print_unit,'(/A,13x,I6, 1x, E15.7)')&
                          'gpn: call GP_Mutations n_GP_Mutations, prob_no_elite', &
