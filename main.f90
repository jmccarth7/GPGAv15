...
!xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
   ...
   do  i_GP_Generation= 1, n_GP_Generations
    ...
    ! send them all to GA_lmdif for parameter optimization on generation 1
      ...
      GP_Child_Population_Node_Type = GP_Adult_Population_Node_Type   ! jjm 20150107
...
! broadcast GP_Adult_Population_Node_Type changed by GP_Clean_Tree_Nodes
   ...
   if( myid == 0 )then
       write(GP_print_unit,'(/A,1x,I6)') '0: i_GP_generation', i_GP_generation
       write(GP_print_unit,'(/A)') &
                  '0: i_GP_Indiv  GP_Child_Indiv_SSE  SSE/SSE0'
    
       do  i_GP_Individual=1,n_GP_Individuals
            write(GP_print_unit,'(6x,I6,2(2x,E15.7))') &
