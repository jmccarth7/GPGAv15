...
!=============================================================================================
    ...
    GP_Individual_Node_Type(96,42)= 0
    GP_Individual_Node_Parameters(96,42)="[96] (P)   1.00000000"];
    GP_Individual_Node_Type(97,42)="[97] (V)       0.00"];
    GP_Individual_Node_Type(49,42)= 3  !  "[49] *"];
    GP_Individual_Node_Type(98,42)= 0
    GP_Individual_Node_Parameters(98,42)="[98] (P)   1.00000000"];
    GP_Individual_Node_Type(99,42)="[99] (V)       0.00"];
    GP_Individual_Node_Type(25,42)= 3  !  "[25] *"];
    GP_Individual_Node_Type(50,42)= 0
    GP_Individual_Node_Parameters(50,42)="[50] (P)   1.00000000"];
    GP_Individual_Node_Type(51,42)="[51] (V)       0.00"];
    GP_Individual_Node_Type(13,42)= 0
    GP_Individual_Node_Parameters(13,42)="[13] (P)   1.00000000"];
...
!=============================================================================================
    ...
    GP_Individual_Node_Type(128,54)= 0
    GP_Individual_Node_Parameters(128,54)="[128] (P)   1.00000000"];
    GP_Individual_Node_Type(129,54)="[129] (V)       0.00"];
    GP_Individual_Node_Type(65,54)= 0
    GP_Individual_Node_Parameters(65,54)="[65] (P)   1.00000000"];
    GP_Individual_Node_Type(33,54)= 8  !  "[33] pow"];
    GP_Individual_Node_Type(66,54)="[66] (V)       0.00"];
    GP_Individual_Node_Type(67,54)= 0
    GP_Individual_Node_Parameters(67,54)="[67] (P)   2.00000000"];
    ...
    GP_Individual_Node_Type(160,54)= 0
    GP_Individual_Node_Parameters(160,54)="[160] (P)   1.00000000"];
    GP_Individual_Node_Type(161,54)="[161] (V)       0.00"];
    GP_Individual_Node_Type(81,54)= 0
    GP_Individual_Node_Parameters(81,54)="[81] (P)   1.00000000"];
    GP_Individual_Node_Type(41,54)= 8  !  "[41] pow"];
    GP_Individual_Node_Type(82,54)="[82] (V)       0.00"];
    GP_Individual_Node_Type(83,54)= 0
    GP_Individual_Node_Parameters(83,54)="[83] (P)   2.00000000"];
    ...
    GP_Individual_Node_Type(96,54)= 0
    GP_Individual_Node_Parameters(96,54)="[96] (P)   1.00000000"];
    GP_Individual_Node_Type(97,54)="[97] (V)       0.00"];
    GP_Individual_Node_Type(49,54)= 0
    GP_Individual_Node_Parameters(49,54)="[49] (P)   1.00000000"];
    GP_Individual_Node_Type(25,54)= 8  !  "[25] pow"];
    GP_Individual_Node_Type(50,54)="[50] (V)       0.00"];
    GP_Individual_Node_Type(51,54)= 0
    GP_Individual_Node_Parameters(51,54)="[51] (P)   2.00000000"];
