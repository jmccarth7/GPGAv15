...
do  i_part = 1,  n_partitions
    ...
    if( myid == 0 ) then
        ...
        !call MPI_BCAST( GP_Population_Initial_Conditions(1,ind1), message_len,    &
        ...
        !call MPI_BCAST( GP_Population_Node_Parameters(1,1,ind1), message_len,    &
        !                MPI_double_precision,  0, MPI_COMM_WORLD, ierr )
    ...
    elseif( i_gp_1 <= myid  .and.   &
        ...
        do  i_GP_individual= ind1, ind2    ! 1,n_GP_individuals
            ...
            buff_parm_send(i_GP_individual) = n_GP_parameters
            ...
            if( Run_GP_Calculate_Fitness(i_GP_Individual) ) then
                ...
                write(6,'(A,2(1x,I3))') 'gil: call GPCODE myid, new_rank ',&
                                                          myid, new_rank
        ...
        if( new_rank == 0 )then
            ...
            n_indiv = ind2 - ind1 + 1
            call MPI_SEND( buff_parm_send(ind1), n_indiv, MPI_INTEGER,        &
