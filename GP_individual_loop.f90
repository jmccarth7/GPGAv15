subroutine GP_individual_loop( new_group, new_comm )
...
do  i_part = 1, n_partitions
    ...
    gp_ind_loop:&
    do  i_GP_individual= i_gp_1 , i_gp_2  ! 1,n_GP_individuals
        ...
        if( n_GP_parameters > n_maximum_number_parameters )then
            ...
            if( myid == 0 )then
                write(GP_print_unit,'(/A,3(1x,I5),2(1x,I10))')&
                  'gil:WARNING  myid, i_GP_generation, i_GP_Individual, &
        ...
        if( Run_GP_Calculate_Fitness(i_GP_Individual) ) then
            ...
            write(GP_print_unit,'(/A,3(1x,I6), 1x, E15.7)')&
                  'gil:1 new_rank, i_GP_gen, i_GP_indiv, GP_pop_fit(i_GP_indiv) ', &
