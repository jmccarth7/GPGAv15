...
FFLAGS =   -O3  -ffree-form  -ffpe-trap='denormal' #-g  -fbacktrace -ffree-form -fcheck=bounds # -Wall  #-fdefault-integer-8  # -FR = -free
...
F90FLAGS =  -O3  -ffree-form  -ffpe-trap='denormal' #-g  -fbacktrace -ffree-form -fcheck=bounds # -Wall  #-fdefault-integer-8  # -FR = -free
...
deserialize_trees.o: GP_variables_module.o Tree_Helper_module.o \
	class_tree_node.o kinds_mod.o tree_node_factory_module.o
