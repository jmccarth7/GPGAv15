...
SRCS =	0GPCODE_GA_lmdif_Parameter_Optimization_test.f90 allocate_arrays1.f90 \
	...
	comp_data_variance.f90 count_parens.f90 create_equations.f90 \
	create_tree_node_string.f90 deallocate_arrays1.f90 enorm.f90 \
	Fasham_Forcing.f90 fcn.f90 fdjac2.f90 fill_string_arrays.f90 \
	...
	load_pow2_level.f90 mpi_module.f90 Numerical_methods.f90 \
	...
	set_answer_arrays.f90 set_modified_indiv.f90 Setup.f90 \
	...
	swap_module.f90 Tree_Helper.f90 Tree_Serialization.f90 Trees.f90 \
	Variables.f90 Global_Setup.f03 Interfaces.f03 Math_Node_Functions.f03 \
	tree_module.f03 Tree_Node.f03 Tree_Node_Factory.f03
...
OBJS =	0GPCODE_GA_lmdif_Parameter_Optimization_test.o allocate_arrays1.o \
	...
	comp_data_variance.o count_parens.o create_equations.o \
	create_tree_node_string.o deallocate_arrays1.o enorm.o \
	Fasham_Forcing.o fcn.o fdjac2.o fill_string_arrays.o \
	...
	mpi_module.o Numerical_methods.o parse_fbio_strings.o print4.o \
	print_debug_integer_node_tree.o print_debug_real_node_tree.o \
	print_debug_real_nparm.o print_entire_tree.o print_trees.o \
	print_values1.o print_values2.o qrfac.o qrsolv.o random_real.o \
	read_cntl_stuff.o reduce_constant.o reduce_expression.o \
	remove_abs_zero.o remove_double_parens.o remove_string_blanks.o \
	RKBM.o rm_exp_paren.o Runge_Kutta_Box_Model_new.o \
	select_best_RK_lmdif_result.o \
	set_answer_arrays.o set_modified_indiv.o Setup.o setup_run_fcn.o \
	setup_run_lmdif.o setup_run_para_lmdif.o sort.o sse0_calc.o \
	summary_GP_indiv.o summary_GP_indiv2.o swap_module.o Tree_Helper.o \
	Tree_Serialization.o Trees.o Variables.o Global_Setup.o Interfaces.o \
	Math_Node_Functions.o tree_module.o Tree_Node.o \
	Tree_Node_Factory.o
...
0GPCODE_GA_lmdif_Parameter_Optimization_test.o: GA_parameters_module.o \
	...
	GP_variables_module.o  Tree_Node.o \
	Tree_Node_Factory.o mpi_module.o
...
deallocate_arrays1.o: GA_parameters_module.o GA_variables_module.o \
	GP_data_module.o GP_model_parameters_module.o GP_parameters_module.o \
	GP_variables_module.o  mpi_module.o
Fasham_Forcing.o: GP_variables_module.o Variables.o
...
Generate_Dot_Graph.o: Tree_Node.o
...
set_modified_indiv.o: GA_parameters_module.o GA_variables_module.o \
	GP_data_module.o GP_parameters_module.o GP_variables_module.o \
	 mpi_module.o
Setup.o: GP_model_parameters_module.o GP_variables_module.o Variables.o
...
summary_GP_indiv2.o: GA_parameters_module.o GA_variables_module.o \
	GP_data_module.o GP_parameters_module.o GP_variables_module.o \
	 mpi_module.o
Tree_Helper.o: Tree_Node.o
Tree_Serialization.o: GP_variables_module.o Tree_Helper.o Tree_Node.o \
	Tree_Node_Factory.o 
Trees.o: GP_variables_module.o Interfaces.o Tree_Node.o Tree_Node_Factory.o \
	Variables.o
Global_Setup.f03: Math_Node_Functions.o Tree_Node_Factory.o
Interfaces.f03: Tree_Node.o
tree_module.f03: Tree_Node.o
Tree_Node.f03: Math_Node_Functions.o
Tree_Node_Factory.f03: Tree_Node.o
