...
SRCS =	0GPCODE_GA_lmdif_Parameter_Optimization_test.f90 allocate_arrays1.f90 \
	...
	class_tree_node.f90 clock_module.f90 close_output_unit.f90 \
	...
	deallocate_arrays1.f90 deserialize_trees2.f90 enorm.f90 erfc.f90 \
	...
	read_all_summary_file.f90 read_cntl_stuff.f90  \
...
OBJS =	0GPCODE_GA_lmdif_Parameter_Optimization_test.o allocate_arrays1.o \
	...
	calc_stats.o check_for_elite.o class_serialization_visitor.o \
	class_tree_node.o clock_module.o close_output_unit.o \
	...
	deserialize_trees2.o enorm.o erfc.o erfcc.o Fasham_Forcing.o \
	...
	read_all_summary_file.o read_cntl_stuff.o  \
...
Generate_Dot_Graph.o: GP_parameters_module.o  class_tree_node.o kinds_mod.o
