...
SRCS =	0GPCODE_GA_lmdif_Parameter_Optimization_test.f90 allocate_arrays1.f90 \
	...
	combine_tree_strings.f90 comp_data_variance.f90 \
	corr.f90 count_parens.f90 create_equations.f90 \
	create_tree_node_string.f90 deallocate_arrays1.f90 \
	deserialize_trees2.f90 enorm.f90 erfc.f90 erfcc.f90 \
	Fasham_Forcing.f90 fasham_model_debug.f90 fasham_tree_functions.f90 \
	...
	read_all_summary_file.f90 read_cntl_stuff.f90 read_GP_restart.f90 \
	read_input_data.f90 read_input_data_size.f90 reduce_constant.f90 \
	reduce_expression.f90 remove_abs_zero.f90 remove_double_parens.f90 \
	remove_string_blanks.f90 RKBM.f90 rm_exp_paren.f90 \
	Runge_Kutta_Box_Model_data.f90 Runge_Kutta_Box_Model_new.f90 \
	select_best_RK_lmdif_result.f90 serialize_trees.f90 \
	set_answer_arrays.f90 set_forcing_node.f90 set_modified_indiv.f90 \
	setup1.f90 setup_math_functions.f90 setup_run_fcn.f90 \
...
OBJS =	0GPCODE_GA_lmdif_Parameter_Optimization_test.o allocate_arrays1.o \
	...
	combine_tree_strings.o comp_data_variance.o \
	corr.o count_parens.o create_equations.o create_tree_node_string.o \
	deallocate_arrays1.o deserialize_trees2.o enorm.o erfc.o erfcc.o \
	...
	read_all_summary_file.o read_cntl_stuff.o read_GP_restart.o \
