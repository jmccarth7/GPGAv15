...
SRCS =	0GPCODE_GA_lmdif_Parameter_Optimization_test.f90 allocate_arrays1.f90 \
	...
	combine_tree_strings.f90 comp_data_variance.f90 corr.f90 \
	...
	random_real.f90 read_cntl_stuff.f90 read_input_data.f90 \
...
FFLAGS =  -g  -ffpe-trap='denormal'#-fbacktrace -ffree-form -fcheck=bounds# -Wall  #-fdefault-integer-8  # -FR = -free
...
F90FLAGS =  -g  -ffpe-trap='denormal'#-fbacktrace -ffree-form -fcheck=bounds# -Wall  #-fdefault-integer-8  # -FR = -free
...
GP_Tree_Swap.o: GA_parameters_module.o GA_variables_module.o \
	GP_parameters_module.o GP_variables_module.o mpi_module.o
GP_variables_module.o: GP_parameters_module.o class_tree_node.o
...
print_time_series.o: GA_parameters_module.o GA_variables_module.o \
	GP_data_module.o GP_parameters_module.o GP_variables_module.o \
	class_tree_node.o mpi_module.o tree_node_factory_module.o
...
RKBM.o: GP_parameters_module.o GP_variables_module.o mpi_module.o
...
setup_run_para_lmdif.o: GA_parameters_module.o GA_variables_module.o \
	GP_data_module.o GP_parameters_module.o GP_variables_module.o \
	mpi_module.o
sort.o: GA_parameters_module.o GP_parameters_module.o mpi_module.o \
	swap_module.o
...
tree_node_factory_module.o: class_tree_node.o mpi_module.o
