...
contains
    ...
    function Tree_Parameter_Node_Val(this) result(v)
        ...
        !write(60,'(A,1x,E24.16)') 'tPnv: this%param = ', this%param
        !write(60,'(A,1x,E24.16)') 'tPnv: parm = ', v
    ...
    function Tree_Variable_Node_Val(this) result(v)
        ...
        !write(60,'(A,1x,E24.16)')'tVnv: this%variable   = ', this%variable
        !write(60,'(A,1x,I6)')   'tVnv: this%node_count = ', this%node_count
        !write(60,'(A,1x,E24.16)')'tVnv: variable = ', v
