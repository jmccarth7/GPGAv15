...
real(kind=8),&
 ...
 !orig dimension(n_GP_parameters,n_GA_individuals) ::  parent_parameters
real(kind=8),&
 dimension(n_GP_parameters,n_GA_individuals) ::  child_parameters       ! debug only
 !orig dimension(n_GP_parameters,n_GA_individuals) ::  child_parameters
...
do  i_GA_generation = 1, n_GA_Generations
    ...
    !        write(6,'(/A,2(1x,I3)/)') &
    !         'GP_GA_opt: new_rank, n_GA_individuals = ', new_rank, n_GA_individuals
    !        do  i_ga_ind = 1, n_GA_individuals
    ...
    !                                         '       n_GA_individuals =', &
    !                                                 n_GA_individuals
    !        write(6,'(/A,1x,I4,1x,A,2(1x,I6))') &
    !          'GP_GA_opt: begin RK fcn integration   i_GA_generation =', &
    !                                                 i_GA_generation,    &
    !                                         '       n_GA_individuals, myid =', &
    !                                                 n_GA_individuals, myid
    !    endif ! L_ga_print
    !endif !  new_rank == 0
    ...
    if( new_rank == 0  )then
        ...
        do  isource = 1, n_GA_individuals
            ...
            if( Run_GA_lmdif(i_individual) ) then
                ...
                !    write(6,'(A,2(1x,I3),1x,E15.7, 1x,I3)') &
...
!if( L_ga_print )then
    !write(6,'(/A,2(1x,I6))') &
    ! 'GP_GA_opt: broadcast individual_fitness myid, new_rank  = ', myid, new_rank
!endif ! L_ga_print
...
!    'GP_GA_opt: bef broadcast myid, new_rank, ierr, Individual_SSE_best_parent = ', &
