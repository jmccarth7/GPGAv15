...
if( myid == 0 )then
    ...
    do  i = 1, n_input_data_points
        ...
        write(plot_unit,'(I6,2x,3(2x,E15.7))') &
              i, Numerical_CODE_Solution(i,1),  input_data_array(0,i), &
                 input_data_array(0,i) - Numerical_CODE_Solution(i,1)
    enddo ! i
    ...
    write(GP_print_unit, '(A,1x,5(1x,E15.7))') &
          'pts: RK_Soln', RKmean, RKrms, RKstddev, RK_min, RK_max
    write(GP_print_unit, '(A,1x,5(1x,E15.7))') &
          'pts: data   ', data_mean, data_rms, data_stddev, data_min, data_max
    write(GP_print_unit, '(A,1x,5(1x,E15.7)/)') &
          'pts: resid  ', resid_mean, resid_rms, resid_stddev, resid_min, resid_max
    write(GP_print_unit, '(A,1x,5(1x,E15.7))') &
          'pts: correlation coef. ', r_corr
