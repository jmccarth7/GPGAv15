...
!    write(6,'(A,4x,L1)') &
!          'fcn: aft call Runge_Kutta_Box_Model  L_bad_result = ', &
!                                                L_bad_result
!    iflag = -1
!    return
!endif
...
!    !else
!
!        !write(6,'(/A, 1x,I10)')'fcn: bad variance i_time_step ', &
!        !                                          i_time_step
!        !write(6,'(A,1(1x,I6), 1x,E15.7)') &
!        !      'fcn: i_CODE_equation, data_variance(i_CODE_equation)              ', &
!        !            i_CODE_equation, data_variance(i_CODE_equation)
!
...
!  !      'fcn: i_time_step, fvec ', &
!  !            i_time_step, fvec(i_time_step)
!
!enddo ! i_time_step

!write(6,'(A,2x,E24.16)') 'fcn: SSE = ',SSE
